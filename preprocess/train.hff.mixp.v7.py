...
if __name__ == "__main__":
    ...
    hic_file = '/archive/bioinformatics/Zhou_lab/shared/pavdeyev/hic_na/data/hff.microc.res1000/4DNFI9FVHJZQ.hff.res1000.mcool::/resolutions/1000'
    
    SUB_DATA_PROB = 0.5
    subhic_file = '/archive/bioinformatics/Zhou_lab/shared/pavdeyev/hic_na/data/hff.microc.res1000/4DNFI9FVHJZQ.hff.res1000.p0.1.mcool::/resolutions/1000'
    normat_file = '/archive/bioinformatics/Zhou_lab/shared/pavdeyev/hic_na/data/hff.microc.res1000/4DNFI9FVHJZQ.hff.res1000.expected.res1000.csv.npy'

    ref_g_file_fa = '/archive/bioinformatics/Zhou_lab/shared/pavdeyev/ref_genomes/hg38/Homo_sapiens.GRCh38.dna.primary_assembly.fa'
    ref_g_file_mmap = '/archive/bioinformatics/Zhou_lab/shared/pavdeyev/ref_genomes/hg38/Homo_sapiens.GRCh38.dna.primary_assembly.fa.0.mmap'
    ...
    modelstr = f"hff.r1000.p{SUB_DATA_PROB}.wocg"
        ...
        if i % validation_output == 0:
            ...
            for sequence, subinp250, subtarg250, targ250 in zip(
                ...
                if np.mean(np.isnan(targ250)) < 0.7:
                    ...
                    target250_t = torch.Tensor(subtarg250)
                    ...
                    if t < 10:
                        ...
                        figshow(subtarg250[0, :, :], np=True)
                        plt.savefig("./png/" + modelstr + ".test" + str(t) + ".subtar.png")
                    ...
                    target = subtarg250.reshape(pred.shape[0], -1)
