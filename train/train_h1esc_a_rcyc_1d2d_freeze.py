...
from recycle_modules import NetRcyc1d2df
...
modelstr = "h1esc_a_rcyc_1d2d_freeze"
seed = 314
N_rcyc = 2
...
if __name__ == "__main__":
    ...
    bceloss = nn.BCELoss()
    try:
        net = nn.DataParallel(NetRcyc1d2df(num_1d=32))
        net.load_state_dict(
        ...
        for param in net.module.mEncoder.parameters():
            param.requires_grad = True
        for param in net.module.mconv.parameters():
            param.requires_grad = True
