...
from recycle_modules import NetGnorm

# Suppress/hide the warning
np.seterr(invalid="ignore")

modelstr = "h1esc_a_gnorm"
seed = 314
...
pretrained_dict_keys.append("module.lconv1.0.weight")
pretrained_dict_keys.append("module.lconv1.0.bias")
pretrained_dict_keys.append("module.lconv1.2.weight")
pretrained_dict_keys.append("module.lconv1.2.bias")
for i in range(2, 8):
    pretrained_dict_keys.append("module.lconv"+str(i)+".1.weight")
    pretrained_dict_keys.append("module.lconv"+str(i)+".1.bias")
    pretrained_dict_keys.append("module.lconv"+str(i)+".3.weight")
    pretrained_dict_keys.append("module.lconv"+str(i)+".3.bias")    
for i in range(1, 8):
    pretrained_dict_keys.append("module.conv"+str(i)+".0.weight")
    pretrained_dict_keys.append("module.conv"+str(i)+".0.bias")
    pretrained_dict_keys.append("module.conv"+str(i)+".3.weight")
    pretrained_dict_keys.append("module.conv"+str(i)+".3.bias")
pretrained_dict_keys.append("module.lconvtwos.0.1.weight")
pretrained_dict_keys.append("module.lconvtwos.0.1.bias")
pretrained_dict_keys.append("module.lconvtwos.0.3.weight")
pretrained_dict_keys.append("module.lconvtwos.0.3.bias")
for i in range(1, 19):
    pretrained_dict_keys.append("module.lconvtwos."+str(i)+".0.weight")
    pretrained_dict_keys.append("module.lconvtwos."+str(i)+".0.bias")
    pretrained_dict_keys.append("module.lconvtwos."+str(i)+".2.weight")
    pretrained_dict_keys.append("module.lconvtwos."+str(i)+".2.bias")
for i in range(19):
    pretrained_dict_keys.append("module.convtwos."+str(i)+".0.weight")
    pretrained_dict_keys.append("module.convtwos."+str(i)+".0.bias")
    pretrained_dict_keys.append("module.convtwos."+str(i)+".3.weight")
    pretrained_dict_keys.append("module.convtwos."+str(i)+".3.bias")
pretrained_dict_keys += ['module.final.0.weight',
                        'module.final.0.bias',
                        'module.final.3.weight',
                        'module.final.3.bias',
                        'module.final_1d.0.weight',
                        'module.final_1d.0.bias',
                        'module.final_1d.3.weight',
                        'module.final_1d.3.bias']
...
if __name__ == "__main__":
    ...
    bceloss = nn.BCELoss()
    try:
        net = nn.DataParallel(NetGnorm(num_1d=32))
        net.load_state_dict(
        ...
        for key in pretrained_dict_keys:
            net_dict[key] = pretrained_dict[re.sub(r"^module.", "module.module.", key)]
